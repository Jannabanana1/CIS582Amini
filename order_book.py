    ...
    for existing_order in orders:
      if find_match(order, existing_order):
        ...
        if order.buy_amount > existing_order.sell_amount:
                ...
                child['sell_amount'] = 0.9*((order.buy_amount - existing_order.sell_amount) * order.buy_amount/order.sell_amount )
        ...
        if existing_order.sell_amount > order.buy_amount:
                ...
                child['buy_amount'] = 1.1*((existing_order.sell_amount - order.buy_amount) * existing_order.buy_amount/existing_order.sell_amount )
